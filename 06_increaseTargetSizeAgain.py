...
def create_model(num_of_classes):
    ...
    cnn.add(tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(shape_initializer[0], shape_initializer[1], 3))) 
...
def main():
    ...
    model_path = 'modelCollector/increaseTargetSizeAgain'
